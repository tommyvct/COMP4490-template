...
//
//  Tessellating a quad. Do the wave!
//
...
const char *WINDOW_TITLE = "Wave Tessellation";
const double FRAME_RATE_MS = 1000.0/60.0;

typedef glm::vec4  color4;
typedef glm::vec4  point4;

const int NumVertices = 4; // One quad
...
int      Axis = -1;
GLfloat  Theta[NumAxes] = { -45.0, -15.0, 15.0 };
...
init()
{
    ...
    GLuint program = InitShader( "vshader_t2.glsl", "fshader_t2.glsl", "tcs_t3.glsl", "tes_t3.glsl" );
    ...
    //       grouped into a patch; here, one quad == 4 vertices
