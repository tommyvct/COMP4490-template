// Based on: http://www.cs.unm.edu/~angel/BOOK/INTERACTIVE_COMPUTER_GRAPHICS/SIXTH_EDITION/CODE/CHAPTER07/WINDOWS_VERSIONS/example1.cpp
...
const char *WINDOW_TITLE = "Texture Mapped Cube";
...
init()
{
    ...
    GLuint program = InitShader( "vshader9.glsl", "fshader9.glsl" );
